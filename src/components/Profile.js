...
export default class Profile extends Component {
  ...
  showEdit(visible) {
    this.setState({ editVisibleStatus: visible })
  }
      ...
      <View style={{ flex: 1, backgroundColor: '#fff' }}>
        ...
        <Modal
          ...
          <View style={{ justifyContent: 'center', alignItems: 'center', backgroundColor: '#fff' }}>
              ...
              <Item success={this.state.isValid} error={this.state.isInvalid}>
                <TextInput
                 ...
                 returnKeyType="send"
                />
                <Icon type="material-community" size={25} color='red' name="settings-outline" />
              </Item>
            <TouchableOpacity onPress={() => { this.setState({ isValid: true }) }}>
              <Text>Verificar</Text>
            </TouchableOpacity>
